...
import { Truck, LogOut, Building2 } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-slate-50" data-testid="facility-home">
      ...
      <main className="max-w-3xl mx-auto px-6 py-24 text-center">
        ...
        <h1 className="font-archivo font-bold text-3xl text-slate-900 mb-3">Facility Portal</h1>
        <p className="text-slate-600 text-base">
          Your facility dashboard is coming soon. From here you'll post delivery jobs, track shipments in transit, and manage your billing.
        </p>
      </main>
    </div>
  );
